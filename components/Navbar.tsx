  ...
  const mobileMenu = (
    <div
      ...
      className={cn(
        ...
        'pt-24 sm:pt-28 pb-[max(1.5rem,env(safe-area-inset-bottom))] px-5 sm:px-8',
    ...
    >
      ...
      <div className="relative mx-auto flex w-full max-w-xl flex-col">
        <div className="mb-4 sm:mb-5 pr-14">
          ...
          {navItems.map((item) => {
            ...
            return (
              <Link
                ...
                className={cn(
                  'group flex min-h-[62px] items-center gap-3.5 sm:gap-4 transition-all duration-200',
                  item.featured
