    ...
    <footer className="bg-aegrix-bg border-t border-aegrix-border px-4 pt-10 pb-28 sm:px-6 lg:px-12 lg:pt-20 lg:pb-10">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="flex flex-col lg:flex-row lg:justify-between mb-8 lg:mb-20">
          ...
          <div className="flex items-center gap-4 lg:block">
            <Link href="/" className="inline-block relative group shrink-0">
              ...
              <Image 
                ...
                width={112} 
                height={30}
                className="w-28 h-auto object-contain hidden dark:block brightness-110 transition-all duration-500 group-hover:scale-105 lg:w-[140px] lg:mb-8"
              />
              ...
              <Image 
                ...
                width={112} 
                height={30}
                className="w-28 h-auto object-contain dark:hidden transition-all duration-500 group-hover:scale-105 lg:w-[140px] lg:mb-8"
              />
            </Link>
          ...
          <p className="hidden lg:block text-sm text-aegrix-muted leading-relaxed mb-8 max-w-xs">
        ...
        <div className="grid grid-cols-2 gap-8 lg:grid-cols-3 lg:gap-16">
          ...
          {/* Links 2: Empresa */}
          <div>
            <h4 className="text-[10px] sm:text-xs font-bold text-aegrix-text uppercase tracking-[0.2em] mb-4 lg:mb-8">Empresa</h4>
            <ul className="space-y-3 lg:space-y-4">
              {[
        ...
        {/* Badge Status */}
        <div className="mt-8 flex justify-center lg:justify-start lg:mt-0">
        ...
        {/* Bottom Bar */}
        <div className="mt-8 pt-6 border-t border-aegrix-border flex flex-col lg:flex-row items-center justify-between gap-6 lg:mt-16">
          ...
          <div className="flex flex-wrap items-center justify-center gap-x-6 gap-y-3 text-[10px] font-bold text-aegrix-text/30 uppercase tracking-widest lg:justify-end">
