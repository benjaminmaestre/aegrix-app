    ...
    <section className="section-padding bg-black relative overflow-hidden">
      ...
      <div className="container-width relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-24">
          <h2 className="text-4xl md:text-6xl font-sora font-extrabold text-white mb-8 tracking-tight">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {capabilities.map((cap, idx) => (
            <motion.div
              ...
              className="p-8 rounded-2xl bg-white/2 border border-white/5 hover:border-aegrix-cyan/20 transition-all group"
            >
              <div className="w-12 h-12 rounded-xl bg-aegrix-cyan/5 flex items-center justify-center text-aegrix-cyan mb-6 group-hover:bg-aegrix-cyan group-hover:text-black transition-all duration-500">
                <cap.icon size={24} />
              </div>
              <h3 className="text-xl font-sora font-bold text-white mb-3">{cap.title}</h3>
